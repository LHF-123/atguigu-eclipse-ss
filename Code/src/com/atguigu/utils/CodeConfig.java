...
public interface CodeConfig {
	...
	public static int CODE_TIMEOUT = 120;//验证码有效时间
	
	public static int CODE_TIMES_1DAY = 3;//单日最多发送次数
	
	public static int SECONDS_PER_DAY = 60*60*24;//单日秒数
	
	public static String HOST = "192.168.1.100";//主机地址
	
	public static int POST = 6379;//端口号
